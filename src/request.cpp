...
response requests::get(string host,string uri,uint16_t port,
...
response requests::post(string host,string uri,uint16_t port,
			unordered_map<string,string> headers,
			string json_data,
			unordered_map<string,string> data,
			CookieJar *cookie,
...
response requests::request_and_recv(string host,
						string uri,
						int sockfd,
						string headers,
						CookieJar *cookie,
...
string requests::make_header(string base_header,
				   string host,
				   string uri,
...
int requests::init(string host,uint16_t port){
	int sockfd=-1;
